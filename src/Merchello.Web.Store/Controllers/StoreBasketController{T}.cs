namespace Merchello.Web.Store.Controllers
{
	...
	public abstract class StoreBasketController<TBasketModel, TAddItem> : BasketControllerBase<TBasketModel, StoreLineItemModel, TAddItem>
		...
		where TAddItem : class, IAddItemModel, new()
	{
		...
		/// The <see cref="BasketItemExtendedDataFactory{TAddItem}"/>.
		/// </param>
		public StoreBasketController(BasketItemExtendedDataFactory<TAddItem> addItemExtendedDataFactory)
			: base(addItemExtendedDataFactory, new AddItemModelFactory<TAddItem>(), new BasketModelFactory<TBasketModel>())
		{
		}
		...
		/// </remarks>
		protected override ActionResult HandleAddItemSuccess(TAddItem model)
		{
		...
		/// The <see cref="ActionResult"/>.
		/// </returns>
		protected override ActionResult HandleAddItemException(TAddItem model, Exception ex)
		{
			if (Request.IsAjaxRequest())
			{
