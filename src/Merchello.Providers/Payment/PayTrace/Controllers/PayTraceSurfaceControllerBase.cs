namespace Merchello.Providers.Payment.PayTrace.Controllers
{
	...
	/// <summary>
	/// The PayTrace surface controller base.
	/// </summary>
	public abstract class PayTraceSurfaceControllerBase : MerchelloSurfaceController, IPaymentMethodUiController, IPayTraceSurfaceController
	{
		/// <summary>
